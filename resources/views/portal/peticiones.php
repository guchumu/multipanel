...
<div class="card portal-card mb-4">
    <div class="card-body">
        ...
        <p class="small text-muted mb-3">Indica el título o pega un enlace de IMDb o Filmaffinity. Se asociará a tu usuario<?= !empty($portalUser->telegram_chat_id) ? ' y Telegram' : '' ?>.</p>
        <form method="POST" action="/portal/peticiones">
            ...
            <div class="mb-3">
                <label class="form-label" for="peticion-url">URL <span class="text-muted">(IMDb, Filmaffinity u otra)</span></label>
                <input id="peticion-url" name="url" type="url" class="form-control" placeholder="https://www.imdb.com/title/tt… o filmaffinity.com/es/film…">
            </div>
