...
/**
 * Enlace público firmado: activa o apaga el auto-corte de vídeo Transcode (tenant).
 */
final class VideoTranscodeAutoKillToggleController extends Controller
{
    ...
    public function toggle(Request $request, string $token): Response
    {
        $result = $this->toggles->consumeToken($token);
        if (empty($result['ok'])) {
    ...
    private function page(string $title, string $body, bool $success): string
    {
        ...
        return '<!DOCTYPE html><html lang="es"><head><meta charset="utf-8">'
            ...
            . '<p style="color:#6c757d;font-size:0.9rem;">Solo afecta al auto-corte de vídeo Transcode; no a límites de streams ni pausas temporales.</p>'
            . '</body></html>';
    }
}
