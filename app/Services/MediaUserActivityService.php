...
final class MediaUserActivityService
{
    ...
    private static function labelForActionStatic(string $action): string
    {
        return match ($action) {
            ...
            'media_user.whatsapp_updated' => 'WhatsApp actualizado',
            'media_user.telegram_linked' => 'Telegram vinculado (portal)',
            'media_user.telegram_unlinked' => 'Telegram desvinculado (portal)',
            ...
            'media_user.portal_link_created' => 'Enlace mágico al portal',
            'media_user.portal_link_revoked' => 'Enlace mágico cancelado',
    ...
    private function iconForAction(string $action): string
    {
        return match ($action) {
            ...
            'media_user.telegram_updated', 'media_user.telegram_linked', 'media_user.telegram_unlinked', 'media_user.message_sent' => 'telegram',
            'media_user.whatsapp_updated' => 'whatsapp',
            'media_user.notes_updated' => 'journal-text',
            'media_user.removed_from_server' => 'person-x',
            'media_user.payment_link_created', 'media_user.portal_link_created' => 'credit-card',
            'media_user.portal_link_revoked' => 'x-circle',
