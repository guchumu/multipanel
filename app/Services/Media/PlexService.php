...
final class PlexService
{
    ...
    private function parsePlexSessionArray(array $session): array
    {
        ...
        return [
            ...
            'public_ip' => SessionClientIp::normalize(isset($player['publicAddress']) ? (string) $player['publicAddress'] : ''),
            'lan_ip' => SessionClientIp::normalize(isset($player['address']) ? (string) $player['address'] : ''),
            'machine_id' => (string) ($player['machineIdentifier'] ?? ''),
    ...
    private function parsePlexSession(\SimpleXMLElement $session): array
    {
        ...
        return [
            ...
            'public_ip' => SessionClientIp::normalize(isset($session->Player['publicAddress']) ? (string) $session->Player['publicAddress'] : ''),
            'lan_ip' => SessionClientIp::normalize(isset($session->Player['address']) ? (string) $session->Player['address'] : ''),
            'machine_id' => (string) ($session->Player['machineIdentifier'] ?? ''),
